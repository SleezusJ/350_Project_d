 ...
 *
 *last modified: 12/09/19 by Shane
 *
 */
...
void handleTimerInterrupt(int segement, int sp);
...
int main(){
	...
	int processStackPoint[8];
	for(int i=0;i>8;i++) processStackPoint[i] = 0xff00;
	
	//Table Array
	processStackArray[0] = 0x2000;	//Start of table
	processStackArray[7] = 0x9000;	//End of table
...
void handleTimerInterrupt(int segment, int sp)
{
	...
	CURRENT_PROCESS = processStackArray[0];
	CURRENT_PROCESS = (CURRENT_PROCESS + 2) * 0x1000;	//new process segment
